...
import { Music, Video, Edit, Mic, Settings, Stethoscope, Heart, Users, Mail, Phone } from "lucide-react"
...
export default function ServicesPage() {
  const musicServices = [
    ...
    },
    {
      ...
      description: "High-quality recording sessions for vocals, instruments, and complete musical arrangements.",
    },
    {
      icon: Settings,
  ...
  const medicalServices = [
    ...
    },
    {
      ...
      description: "Specialized in emergency medicine and critical care with extensive ICU experience.",
    },
    {
      icon: Users,
      title: "Medical Oncology",
      description: "Experience in cancer care and oncological treatments from B.P. Koirala Memorial Cancer Hospital.",
    },
  ]
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="animate-fade-in-up text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Professional Services</h1>
        <p className="text-xl text-muted-foreground">Combining medical expertise with creative musical services</p>
      </div>
      ...
      {/* Medical Services */}
      <section className="mb-16">
        <h2 className="text-3xl font-serif font-bold text-center mb-8 animate-slide-in-left">Medical Services</h2>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="text-center">
        <Card className="max-w-2xl mx-auto animate-fade-in-up">
          <CardHeader>
            ...
            <p className="text-muted-foreground">Ready to collaborate or need medical consultation? Let's connect!</p>
          </CardHeader>
